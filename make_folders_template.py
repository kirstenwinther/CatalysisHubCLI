...
reactions = [
    {'reactants': ['OOHstar'], 'products': ['2.0H2Ogas', '-1.5H2gas', 'star']},
...
surfaces = ['Pt']
facets = ['111']
sites = ['top', 'hcp', 'fcc_hcp']  # put sites or additional info is necessary. Use '_' in the case of different adsorbates.
